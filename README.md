...
Tool to interact with Huawei router using its API. This tool worked with most Huawei router.
**This project has been abandoned** . Feel free to fork and improve it, if you like.
